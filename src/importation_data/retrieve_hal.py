...
def req_to_HAL_pd(query):
    """Faire la requete à HAL
    :param str query: requete url
    :return dataframe data: data frame de la réponse
    """
...
def hal_to_csv():
    """Sauvegarder en csv le datagrame
    :param str query: requete url
    :return void
    """
    data = req_to_HAL_pd(query)
    data.to_csv("../data/dois/hal_from_api.csv",index=False, encoding='utf8', sep=';')
